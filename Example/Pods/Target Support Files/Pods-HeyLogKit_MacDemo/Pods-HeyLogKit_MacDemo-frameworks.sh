...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HeyLogKit-OSX/HeyLogKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JSONModel-macOS/JSONModel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit-macOS/SnapKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftHTTP-macOS/SwiftHTTP.framework"
fi
